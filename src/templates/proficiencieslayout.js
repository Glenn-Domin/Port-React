          ...
          <section className='row pb-5'>
            <div className='col-12'>
              ...
              <ul>
                ...
                <li><strong>PHP</strong>: I do well with PHP - much of what I do in a day is in PHP.</li>
